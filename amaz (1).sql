...
DROP DATABASE IF EXISTS `amaz`;
CREATE DATABASE IF NOT EXISTS `amaz`;
USE `amaz`;
...
(10002, 'Todd', 'Spencer', 'M', '1996-09-09', 505, 201, '2021-04-05', 62000),
...
(10015, 'Martha', 'Silk', 'F', '1998-12-12', 510, 202, '2016-10-01', 59350),
...
--
ALTER TABLE `employee`
  MODIFY `emp_num` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10021;
